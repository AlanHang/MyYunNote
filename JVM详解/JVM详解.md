...
![image-20210326165019894](JVM详解.assets/image-20210326165019894.png)

![image-20210326165143786](JVM详解.assets/image-20210326165143786.png)

![image-20210326165351492](JVM详解.assets/image-20210326165351492.png)

# 8. GC 垃圾回收

## 8.1 GC概述

![image-20210326175501880](JVM详解.assets/image-20210326175501880.png)

![image-20210331165759725](JVM详解.assets/image-20210331165759725.png)

![image-20210331170227079](JVM详解.assets/image-20210331170227079.png)

---

**早期的垃圾回收**

![image-20210406172200759](JVM详解.assets/image-20210406172200759.png)

![image-20210406172253716](JVM详解.assets/image-20210406172253716.png)

---

**Java的垃圾回收机制**

![image-20210406172720696](JVM详解.assets/image-20210406172720696.png)

![image-20210406172832023](JVM详解.assets/image-20210406172832023.png)

![image-20210406173259470](JVM详解.assets/image-20210406173259470.png)

## 8.2 垃圾回收算法

**垃圾标记阶段：对象存活判断**

![image-20210406174627354](JVM详解.assets/image-20210406174627354.png)
...
![image-20210406183159879](JVM详解.assets/image-20210406183159879.png)

![image-20210407154243968](JVM详解.assets/image-20210407154243968.png)
...
- 基本思路：
  ...
  ![image-20210407155458265](JVM详解.assets/image-20210407155458265.png)
...
![image-20210407160504296](JVM详解.assets/image-20210407160504296.png)

**注意：**

![image-20210407160741054](JVM详解.assets/image-20210407160741054.png)

### 8.2.3 对象的finalization机制

![image-20210407161115588](JVM详解.assets/image-20210407161115588.png)

![image-20210407161422984](JVM详解.assets/image-20210407161422984.png)

![image-20210407161614134](JVM详解.assets/image-20210407161614134.png)

![image-20210407162104893](JVM详解.assets/image-20210407162104893.png)
...
![image-20210409155853881](JVM详解.assets/image-20210409155853881.png)

### 8.2.7 分代收集算法

![image-20210409160440430](JVM详解.assets/image-20210409160440430.png)

![image-20210409160737641](JVM详解.assets/image-20210409160737641.png)

![image-20210409161016951](JVM详解.assets/image-20210409161016951.png)

### 8.2.8 增量收集算法&分区算法

**增量收集算法**

![image-20210409161655883](JVM详解.assets/image-20210409161655883.png)

![image-20210409161841213](JVM详解.assets/image-20210409161841213.png)

---

**分区算法**

![image-20210409162140391](JVM详解.assets/image-20210409162140391.png)
...
![image-20210415164810755](JVM详解.assets/image-20210415164810755.png)

![image-20210415164922104](JVM详解.assets/image-20210415164922104.png)

### 8.3.3 内存泄漏（Memory Leak）

![image-20210415165500135](JVM详解.assets/image-20210415165500135.png)

![image-20210415171338061](JVM详解.assets/image-20210415171338061.png)

###  8.3.4 Stop The World

![image-20210415171544458](JVM详解.assets/image-20210415171544458.png)

![image-20210415172115997](JVM详解.assets/image-20210415172115997.png)

### 8.3.5 安全点和安全区域

**安全点**

![image-20210415173326194](JVM详解.assets/image-20210415173326194.png)

![image-20210415173649573](JVM详解.assets/image-20210415173649573.png)

**安全区域**

![image-20210415173729930](JVM详解.assets/image-20210415173729930.png)

![image-20210415173907751](JVM详解.assets/image-20210415173907751.png)

### 8.3.6 引用概述

![image-20210415174454728](JVM详解.assets/image-20210415174454728.png)

![image-20210415175008456](JVM详解.assets/image-20210415175008456.png)

**强引用--不回收**

![image-20210416153755392](JVM详解.assets/image-20210416153755392.png)

![image-20210416154012845](JVM详解.assets/image-20210416154012845.png)

**软引用--内存不足即回收**

![image-20210416154100097](JVM详解.assets/image-20210416154100097.png)

![image-20210416154734262](JVM详解.assets/image-20210416154734262.png)

![image-20210416154921248](JVM详解.assets/image-20210416154921248.png)

**弱引用--发现(gc)即回收**

![image-20210416155836548](JVM详解.assets/image-20210416155836548.png)

![image-20210416163155443](JVM详解.assets/image-20210416163155443.png)

**虚引用--对象回收跟踪**

![image-20210416170042505](JVM详解.assets/image-20210416170042505.png)

![image-20210416170422086](JVM详解.assets/image-20210416170422086.png)

## 8.4 垃圾回收器

![image-20210421110505822](JVM详解.assets/image-20210421110505822.png)

**按线程数分，可分为串行垃圾回收器和并行垃圾回收器**

![image-20210421144157125](JVM详解.assets/image-20210421144157125.png)

**按照工作模式分，可以分为并发式垃圾回收器和独占式垃圾回收器**

![image-20210421144434057](JVM详解.assets/image-20210421144434057.png)

![image-20210421144452068](JVM详解.assets/image-20210421144452068.png)

---

**评估GC的性能指标**

![image-20210421144735261](JVM详解.assets/image-20210421144735261.png)

![image-20210421145548030](JVM详解.assets/image-20210421145548030.png)

**吞吐量**

![image-20210421145759703](JVM详解.assets/image-20210421145759703.png)

**暂停时间**

![image-20210421145924732](JVM详解.assets/image-20210421145924732.png)

**吞吐量VS暂停时间**

![image-20210421150408483](JVM详解.assets/image-20210421150408483.png)

![image-20210421150430338](JVM详解.assets/image-20210421150430338.png)

### 8.4.1 Java常见的垃圾收集器

![image-20210421151134169](JVM详解.assets/image-20210421151134169.png)

![image-20210421151823785](JVM详解.assets/image-20210421151823785.png)

**7款经典收集器与垃圾分代之间的关系**

![image-20210421153340836](JVM详解.assets/image-20210421153340836.png)

**垃圾收集器的组合关系**

![image-20210421153410816](JVM详解.assets/image-20210421153410816.png)

![image-20210421154002525](JVM详解.assets/image-20210421154002525.png)

---

查看默认的垃圾回收器

![image-20210421154417969](JVM详解.assets/image-20210421154417969.png)

### 8.4.2 Serial回收器：串行回收

![image-20210421163440468](JVM详解.assets/image-20210421163440468.png)

![image-20210421163533483](JVM详解.assets/image-20210421163533483.png)

![image-20210421163610302](JVM详解.assets/image-20210421163610302.png)

### 8.4.3 ParNew回收器：并且回收

![image-20210421164335885](JVM详解.assets/image-20210421164335885.png)

![image-20210421164407542](JVM详解.assets/image-20210421164407542.png)

![image-20210421164612161](JVM详解.assets/image-20210421164612161.png)

![image-20210421164830679](JVM详解.assets/image-20210421164830679.png)

### 8.4.4 Parallel Scavenge 回收器：吞吐量

![image-20210421164939293](JVM详解.assets/image-20210421164939293.png)

![image-20210421165202074](JVM详解.assets/image-20210421165202074.png)

![image-20210421165636254](JVM详解.assets/image-20210421165636254.png)

![image-20210421165647717](JVM详解.assets/image-20210421165647717.png)

![image-20210421165802724](JVM详解.assets/image-20210421165802724.png)

![image-20210421170253681](JVM详解.assets/image-20210421170253681.png)

![image-20210421173254191](JVM详解.assets/image-20210421173254191.png)

### 8.4.5 CMS回收器：低延迟

![image-20210421174054777](JVM详解.assets/image-20210421174054777.png)

![image-20210421174110701](JVM详解.assets/image-20210421174110701.png)

![image-20210421174216530](JVM详解.assets/image-20210421174216530.png)

![image-20210421174335365](JVM详解.assets/image-20210421174335365.png)

![image-20210421174515932](JVM详解.assets/image-20210421174515932.png)

![image-20210421174721918](JVM详解.assets/image-20210421174721918.png)

![image-20210421175118442](JVM详解.assets/image-20210421175118442.png)

![image-20210421175335144](JVM详解.assets/image-20210421175335144.png)

**CMS参数设置**

![image-20210422160418843](JVM详解.assets/image-20210422160418843.png)

![image-20210422161109091](JVM详解.assets/image-20210422161109091.png)

### 8.4.6 G1回收器：区域分代化

![image-20210422164753904](JVM详解.assets/image-20210422164753904.png)

![image-20210422165337429](JVM详解.assets/image-20210422165337429.png)

![image-20210422165540566](JVM详解.assets/image-20210422165540566.png)

**G1回收器的特点（优势）**

![image-20210422165632967](JVM详解.assets/image-20210422165632967.png)

![image-20210422175208899](JVM详解.assets/image-20210422175208899.png)

![image-20210422175310621](JVM详解.assets/image-20210422175310621.png)

**G1回收器的缺点**

![image-20210422175927213](JVM详解.assets/image-20210422175927213.png)

**G1参数设计**

![image-20210423163522100](JVM详解.assets/image-20210423163522100.png)

**G1回收器的常见操作步骤**

![image-20210423163802232](JVM详解.assets/image-20210423163802232.png)

**G1回收器的适用场景**

![image-20210423163948524](JVM详解.assets/image-20210423163948524.png)

**region**

![image-20210423164520770](JVM详解.assets/image-20210423164520770.png)

![image-20210423165153092](JVM详解.assets/image-20210423165153092.png)
...
![image-20210428161559740](JVM详解.assets/image-20210428161559740.png)

*记忆集*

![image-20210428162444946](JVM详解.assets/image-20210428162444946.png)

**过程1YGC**

![image-20210428163626033](JVM详解.assets/image-20210428163626033.png)
...
![image-20210428164540911](JVM详解.assets/image-20210428164540911.png)

**过程3混合回收**

![image-20210428165005713](JVM详解.assets/image-20210428165005713.png)

![image-20210428165529358](JVM详解.assets/image-20210428165529358.png)

**过程4Full GC**

![image-20210428165633688](JVM详解.assets/image-20210428165633688.png)

![image-20210428170252226](JVM详解.assets/image-20210428170252226.png)
...
![image-20210429170603178](JVM详解.assets/image-20210429170603178.png)

![image-20210429170627673](JVM详解.assets/image-20210429170627673.png)

![image-20210429172319445](JVM详解.assets/image-20210429172319445.png)
